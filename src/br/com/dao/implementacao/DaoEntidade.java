...
public class DaoEntidade extends ImplementacaoCrud<Entidade> implements RepositoryEntidade {
	...
	public boolean existeUsuario(String ent_login) {
		...
		builder.append(" select coun(1) >= 1 from entidade where ent_login = '").append(ent_login).append("' ");
		super.getJdbcTemplate().queryForObject(builder.toString(), Boolean.class);
		return false;
	}
